...
file_handler = logging.FileHandler('GWtunaLambdaEtaO4TPESampler1000CmaEsampler9000LR50bipopincpopsize2Callback500Final.log') # define file handler and set formatter
...
OUTPUT_FILE = DATA_DIR+'GWtunaLambdaEtaO4TPESampler1000CmaEsampler9000LR50bipopincpopsize2Callback500FinalRecoveredSNR.csv'
OUTPUT_FILE2 = DATA_DIR+'GWtunaLambdaEtaO4TPESampler1000CmaEsampler9000LR50bipopincpopsize2Callback500FinalFailed.csv'
...
def injection(constrained_freqs, dynfac, constrained_invpsd, delta_freq, O4_psd, tsamples, delta_t, signal_duration, kmin, kmax, m_chirp, eta, chi1, chi2, tc, des_snr):
...
def snrp(constrained_freqs, dynfac, constrained_invpsd, delta_freq, sampling_rate, signal_duration, kmin, kmax, fcore, m_chirp, eta, chi1, chi2):
    '''Template'''
...
NOM_INJECTIONS = 5000
MIN_MCHIRP = 0.87055056
MAX_MCHIRP = 1.74110113
MIN_ETA = 0.22222222
MAX_ETA = 0.24999999
MIN_SPIN = -0.05
MAX_SPIN = 0.05
